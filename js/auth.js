...
const authApp = {
    ...
    authenticateUser(email, password) {
        ...
        // Check for simple admin/demo login
        if (!user) {
            if (email === 'admin' && password === 'admin') {
                user = users.find(u => u.email === 'admin@healthbox.ae');
            } else if (email === 'demo' && password === 'demo') {
                user = users.find(u => u.role === 'partner');
            }
        }
    ...
    loginFailed() {
        alert('❌ Login fehlgeschlagen!\\n\\nBitte überprüfen Sie Ihre Zugangsdaten.\\n\\nGültige Optionen:\\n• E-Mail: admin@healthbox.ae / Passwort: HealthBox2025!Admin\\n• E-Mail: admin / Passwort: admin\\n• E-Mail: demo / Passwort: demo\\n\\nOder nutzen Sie den Schnell-Login Button!');
    },
