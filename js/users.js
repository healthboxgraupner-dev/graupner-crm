...
const usersModule = {
    ...
    showAddForm() {
        document.body.insertAdjacentHTML('beforeend', `
            <div id="userFormModal" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); 
                 ...
                 onclick="event.target.id === 'userFormModal' && this.remove()">
                <div style="background: white; padding: 30px; border-radius: 12px; max-width: 600px; width: 90%;"
                     onclick="event.stopPropagation()">
                    <h2>Neuer Benutzer</h2>
                    <form id="createUserForm" onsubmit="usersModule.save(event)">
                        ...
                        <button type="button" class="btn" onclick="document.getElementById('userFormModal').remove()" 
    ...
    save(e) {
        ...
        console.log('Neuer Benutzer wird erstellt:', { name, email, role });
