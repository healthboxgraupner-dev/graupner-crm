...
3. **Login**
   - Klicken Sie auf den gelben **"🚀 Direkt als Admin anmelden"** Button
   - Oder verwenden Sie: `admin@healthbox.ae` / `HealthBox2025!Admin`
...
- [x] Login funktioniert (Schnell-Login Button)
...
2. **Klicken Sie auf den gelben Schnell-Login Button**
3. **Erkunden Sie das Dashboard**
4. **Viel Erfolg mit Longevity Capital CRM!** 🚀
